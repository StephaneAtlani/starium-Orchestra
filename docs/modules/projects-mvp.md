...
- **Cockpit liste** : filtres incluant **nature** (`kind`) ; KPI portefeuille en **score cards** denses (`starium-module` + `starium-kpi-card`) — [FRONTEND_UI-UX.md](../FRONTEND_UI-UX.md) §6.1, §7.
