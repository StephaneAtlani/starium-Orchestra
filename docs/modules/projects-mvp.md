...
- **Points projet** : `apps/api/src/modules/projects/project-reviews/` — **51+** tests backend (cycle pilotage RFC-PROJ-013-2, attachments, snapshot v2, agenda, invitations, compte rendu, météo comité) ; frontend `apps/web/src/features/projects/lib/project-review-status.spec.ts` (CTA planifier / démarrer / CR)
