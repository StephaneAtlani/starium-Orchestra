...
| `/budgets/[budgetId]/snapshots` | **Versions figées** (RFC-033) : liste (y compris captures **automatiques** aux statuts Soumis / Validé), création manuelle, lien depuis fiche budget ; détail `/snapshots/[snapshotId]` |
