...
| `BudgetExplorerRow` | Ligne enveloppe ou ligne budgétaire (indentation, chevron, aria) (RFC-FE-004) |
...
- [Budget Cockpit — UI & intégration](budget-cockpit.md) — `/budgets/dashboard`, HT/TTC, fichiers `features/budgets/dashboard/`
