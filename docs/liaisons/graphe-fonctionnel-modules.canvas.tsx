...
const NODES: NodeDef[] = [
  ...
  { id: "compliance", label: "Conformité", layer: "gouvernance", x: 1260, y: 142, w: 160, h: 56 },
...
const LINKS: LinkDef[] = [
  {
    ...
    status: "live",
    horizon: "now",
    rfc: "RFC-PROJ-INTAKE-001 · INTAKE-002",
    flows: ["projet", "gouvernance"],
    note: "Workflow submit / decision / route. CDC A1–A7 : circuit calculé (INTAKE-002).",
  },
  {
    id: "fut-intake-budget",
    from: "intake",
    to: "budgets",
    label: "Enveloppe à la conversion",
    table: "retainedBudget → enveloppe (0 ligne)",
    pattern: "fk",
    status: "future",
    horizon: "next",
    rfc: "RFC-PROJ-INTAKE-003",
    flows: ["argent", "gouvernance", "futur"],
    note: "Ventilation CAPEX/OPEX optionnelle. Chiffrage fin = module Budget.",
  },
  {
    id: "fut-intake-plan",
    from: "intake",
    to: "action-plans",
    label: "Plan cadrage + skeleton",
    table: "seedPlanningSkeleton + ActionPlan",
    pattern: "fk",
    status: "future",
    horizon: "next",
    rfc: "RFC-PROJ-INTAKE-004",
    flows: ["projet", "gouvernance", "futur"],
    note: "Interdit au demandeur. Phase Cadrage + jalon chef de projet à la conversion.",
  },
  {
    id: "fut-intake-agenda",
    from: "intake",
    to: "cycles",
    label: "ODJ + décision comité",
    table: "agendaItem / séance COPIL|CODIR",
    pattern: "overlay",
    status: "future",
    horizon: "next",
    rfc: "RFC-PROJ-INTAKE-002",
    flows: ["gouvernance", "futur"],
    note: "A6 inscription · A7 décision. Aussi Réunions (Meeting ODJ).",
  },
  {
    id: "fut-intake-score-cycle",
    from: "intake",
    to: "cycles",
    label: "Export scores → item cycle",
    table: "ProjectRequestScoreValue → GovernanceCycleItem",
    pattern: "overlay",
    status: "future",
    horizon: "next",
    rfc: "RFC-PROJ-INTAKE-005",
    flows: ["gouvernance", "futur"],
    note: "Aide arbitrage uniquement — jamais auto-décision.",
  },
  {
    id: "fut-intake-external",
    from: "intake-external",
    to: "intake",
    label: "Dépôt invité authentifié",
    table: "ProjectRequest.source=EXTERNAL",
    pattern: "overlay",
    status: "future",
    horizon: "later",
    rfc: "RFC-PROJ-INTAKE-006",
    flows: ["gouvernance", "futur"],
    note: "Magic-link / compte invité scopé client. Pas d'anonyme public.",
  },
  {
    id: "vision-project",
    from: "vision",
