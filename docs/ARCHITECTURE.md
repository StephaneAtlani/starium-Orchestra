...
└── web/   → Next.js frontend
    ...
    ├── features/governance-cycles   (`/cycles`, `/cycles/[cycleId]` — liste, détail, matrice arbitrage, onglet Séances + clôture ; candidature depuis fiche projet ; RFC-FE-PROJ-CYCLE-001 + RFC-PROJ-CYCLE-003)
