...
│   │   ├── governance-cycles   (RFC-PROJ-CYCLE-001 — cycles de pilotage / arbitrage CODIR ; lots B1–B8 : CRUD + scoring + KPI + audits validated/closed)
│   │   └── ...
│   └── prisma / PostgreSQL
│
