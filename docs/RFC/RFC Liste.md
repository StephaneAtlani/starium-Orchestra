...
| **5** | **RFC-FE-026** *(NEW)* | Financial Events Timeline          | Comprendre les impacts financiers          | Timeline unifiée dans le **drawer** ligne (4 sources API, filtres, UX panneau agrandi)                     | 🔥🔥🔥   | ✅ v1 (drawer) |
