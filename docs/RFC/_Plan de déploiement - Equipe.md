...
|     8 | [RFC-TEAM-008](./RFC-TEAM-008%20%E2%80%94%20Staffing%20projet%20par%20manager%20responsable%20projet.md)    | Staffing projet par manager / responsable projet   | Depuis les projets, affecter la charge des équipes sur activités / projets.                                                             | ✅ Implémentée (backend MVP)     | API `/api/projects/:projectId/resource-assignments` ; RBAC `team_assignments.*` ; UI → RFC-FE-TEAM-005.     |
...
|    23 | [RFC-FE-TEAM-005](./RFC-FE-TEAM-005%20%E2%80%94%20UI%20Affectations%20%26%20staffing%20projet.md) | UI Affectations & staffing projet                  | Affectations depuis équipe et depuis projet.                                                                                            | ❌ À faire (RFC rédigée) | Dépend de TEAM-007 / 008 ; spec FE → RFC.        |
