...
|     4 | [RFC-TEAM-004](./RFC-TEAM-004%20—%20Compétences%20des%20collaborateurs.md) | Compétences des collaborateurs                     | Association `Collaborator ↔ Skill` avec niveau, commentaire, date de revue, source et validation manager.                               | ❌ À faire     | Spec complète ; implémentation à venir.            |
