...
|     3 | [RFC-TEAM-003](./RFC-TEAM-003%20—%20Référentiel%20Compétences.md)    | Référentiel Compétences                            | Catalogue client de compétences avec catégories, statuts, niveau de référence, archivage logique.                                       | 📝 RFC rédigée | Base du “qui sait faire quoi”.                   |
