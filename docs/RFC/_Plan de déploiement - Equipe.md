...
|     2 | RFC-TEAM-002    | Référentiel Collaborateurs métier                  | CRUD métier des collaborateurs : identité, type, fonction, manager, statut, source, tags, notes, règles si collaborateur synchronisé.   | ❌ À faire     | Première brique métier réelle du module Équipes. |
