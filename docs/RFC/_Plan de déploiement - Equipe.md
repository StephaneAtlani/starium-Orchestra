...
|     2 | RFC-TEAM-002    | Référentiel Collaborateurs métier                  | CRUD métier des collaborateurs : identité, fonction, manager, statut, source, tags, notes, règles si collaborateur synchronisé.          | 🟡 En cours (backend) | Première brique métier réelle du module Équipes. |
|     3 | RFC-TEAM-003    | Référentiel Compétences                            | Catalogue client de compétences avec catégories, statuts, niveau de référence, archivage logique.                                       | ❌ À faire     | Base du “qui sait faire quoi”.                   |
|     4 | RFC-TEAM-004    | Compétences des collaborateurs                     | Association `Collaborator ↔ Skill` avec niveau, commentaire, date de revue, source et validation manager.                               | ❌ À faire     | Complète le catalogue de compétences.            |
|     5 | RFC-TEAM-005    | Référentiel Équipes / périmètres managers          | Définition des équipes, rattachement des collaborateurs, scopes managers, équipes directes / étendues.                                  | ❌ À faire     | Nécessaire pour une vraie vue manager.           |
...
|    19 | RFC-FE-TEAM-001 | Frontend Foundation — Équipes                      | Structure `features/teams`, routes, query keys, client API, composants communs, conventions d’état.                                     | ❌ À faire     | À lancer tôt en parallèle du backend.            |
|    20 | RFC-FE-TEAM-002 | UI Collaborateurs                                  | Liste, détail, édition, badges, filtres, relation manager, état sync.                                                                   | ❌ À faire     | Premier écran métier.                            |
|    21 | RFC-FE-TEAM-003 | UI Compétences                                     | Catalogue de compétences + gestion des compétences collaborateur.                                                                       | ❌ À faire     | Dépend de TEAM-003 / 004.                        |
|    22 | RFC-FE-TEAM-004 | UI Équipes / scopes managers                       | Équipes, rattachements, périmètres managers.                                                                                            | ❌ À faire     | Dépend de TEAM-005.                              |
