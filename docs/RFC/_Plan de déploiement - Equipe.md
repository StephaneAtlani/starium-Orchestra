...
|    20 | RFC-FE-TEAM-002 | [UI Collaborateurs](./RFC-FE-TEAM-002%20%E2%80%94%20UI%20Collaborateurs.md) | Liste, détail, édition, badges, filtres, relation manager, état sync.                                                                   | 🟡 Draft       | RFC créée, implémentation FE à lancer.           |
