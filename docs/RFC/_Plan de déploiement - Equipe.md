...
|    19 | RFC-FE-TEAM-001 | [Frontend Foundation — Équipes](./RFC-FE-TEAM-001%20%E2%80%94%20Frontend%20Foundation%20%E2%80%94%20%C3%89quipes.md) | Structure `features/teams`, routes, query keys, client API, composants communs, conventions d’état.                                     | 🟡 En cours    | RFC rédigée et alignée sur le socle FE actuel.   |
