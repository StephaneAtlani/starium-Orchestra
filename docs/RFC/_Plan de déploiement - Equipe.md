...
> **Dernière mise à jour documentaire : avril 2026** — alignement avec le dépôt après livraison **RFC-FE-TEAM-005** (UI affectations / staffing). Les colonnes *État* reflètent l’intention produit ; la vérité opérationnelle reste le code et les RFC détaillées.
...
|     7 | [RFC-TEAM-007](./RFC-TEAM-007%20%E2%80%94%20Affectations%20ressources.md)    | Affectations ressources                            | Affectation planifiée d’un collaborateur à un projet ou une activité avec période, rôle, taux de charge.                                | ✅ Implémentée (backend MVP) | API `/api/team-resource-assignments` ; permissions `team_assignments.*`. |
|     8 | [RFC-TEAM-008](./RFC-TEAM-008%20%E2%80%94%20Staffing%20projet%20par%20manager%20responsable%20projet.md)    | Staffing projet par manager / responsable projet   | Depuis les projets, affecter la charge des équipes sur activités / projets.                                                             | ✅ Implémentée (backend MVP)     | API `/api/projects/:projectId/resource-assignments` ; RBAC `team_assignments.*` ; **UI** → [RFC-FE-TEAM-005](./RFC-FE-TEAM-005%20%E2%80%94%20UI%20Affectations%20%26%20staffing%20projet.md) (MVP livré).     |
...
|    23 | [RFC-FE-TEAM-005](./RFC-FE-TEAM-005%20%E2%80%94%20UI%20Affectations%20%26%20staffing%20projet.md) | UI Affectations & staffing projet                  | Liste globale module Équipes + staffing depuis le projet (TEAM-007 / TEAM-008).                                                                                            | ✅ Implémentée (MVP FE) | `/teams/assignments`, onglet **Charge** `/projects/[projectId]/staffing` ; `features/teams/team-assignments/` ; encart fiche collaborateur & `projectTeamRoleId` = **P1**.        |
...
| Phase 3 | TEAM-005✅, TEAM-006✅, TEAM-007✅, TEAM-008✅, FE-TEAM-004✅, FE-TEAM-005✅ | Staffing et affectations (track MVP bouclé) |
