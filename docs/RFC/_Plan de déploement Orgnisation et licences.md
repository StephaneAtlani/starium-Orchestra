...
| **RFC-ORG-004** | Steward, transfert et obligation ownership | Gouvernance avancée de la propriété organisationnelle        | Responsable métier (`steward`), transfert massif audité, politique d’obligation `ownerOrgUnitId` par client      | P1       | 📝 Draft         | RFC-ORG-003 V1, RFC-ACL-022           | `stewardResourceId`, `POST /api/organization/ownership-transfers`, permission `organization.ownership.transfer`, policy ADVISORY / REQUIRED, UI wizard |
...
| 📝 Draft (tranche 2) | **RFC-ORG-004**, **RFC-ACL-025**, **RFC-ACL-026** | Gouvernance ownership V2, guards HTTP resourceId, cockpit exports |
...
| 14 | **RFC-ORG-004** | Code | 📋 À faire | ORG-003 V1, 022 | Steward, `POST …/ownership-transfers`, policy obligation, UI wizard |
...
**Tranche 2 (draft)** : [RFC-ACL-023](./RFC-ACL-023%20%E2%80%94%20Backfill%20ClientUser%20Resource%20HUMAN.md), [RFC-ORG-004](./RFC-ORG-004%20%E2%80%94%20Steward%20transfert%20et%20obligation%20ownership.md), [RFC-ACL-025](./RFC-ACL-025%20%E2%80%94%20Adoption%20guards%20HTTP%20moteur%20unifi%C3%A9.md), [RFC-ACL-026](./RFC-ACL-026%20%E2%80%94%20Cockpit%20mod%C3%A8le%20d%20acc%C3%A8s%20V2.md).
