...
* Pas de client Graph aujourd’hui dans le repo ; à introduire de façon isolée et testable.
...
* `microsoft-graph.service.ts` (ou équivalent) dans le module intégration Microsoft.
* Types TypeScript pour réponses fréquentes (réduire `any`).
