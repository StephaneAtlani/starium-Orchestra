...
La colonne **État** ci-dessus pour ACL-001 à **006** et ACL-009 est alignée avec l’implémentation backend actuelle. **RFC-ACL-010** (cockpits licences / accès) est **implémentée** côté web et API plateforme associée. ACL-007/008 restent en avancement partiel côté frontend (écrans CRUD / ACL ressources) et traçabilité transverse.
