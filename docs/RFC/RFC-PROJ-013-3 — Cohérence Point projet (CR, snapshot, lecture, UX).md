...
**Cadre produit 20 écrans** (PDF spécification fonctionnelle, sept. 2026) : [`RFC-PROJ-013-5`](./RFC-PROJ-013-5%20—%20Spécification%20fonctionnelle%20écrans%20Points%20projet%20(catalogue%2001-20).md) et filles **013-6** (Animer 09 — ✅), **013-7** (listes/préparation — ✅), **013-8** (remontées/CR/F3.1 — ✅), **013-9** (transverse — ✅ C1 · 📝 T2/T4).
