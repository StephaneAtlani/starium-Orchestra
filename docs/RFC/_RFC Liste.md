...
| **RFC-ACL-019** | Diagnostic enrichi (organisation + propriété + politique) | 📝 Draft | Extension matrice / self-diagnostic (`organizationScopeCheck`, ownership, policy) ; voir [RFC](./RFC-ACL-019%20%E2%80%94%20Diagnostic%20enrichi%20organisation%20et%20acc%C3%A8s.md) |
