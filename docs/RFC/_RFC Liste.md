...
| 14d′  | **RFC-PROJ-013-1** | Cycle de vie réunion Point projet | **Phases 1–3 ✅** : cycle, invitations in-app, email, Teams/calendrier | ✅ Livré | [RFC](./RFC-PROJ-013-1%20—%20Cycle%20de%20vie%20réunion%20Point%20projet%20(planification,%20invitations,%20tenue).md) — migrations `20260704120*`, `20260705120000`, `20260705140000` |
| 14d″  | **RFC-PROJ-013-2** | Point projet de pilotage | Recentrage gouvernance : cycle PREPARING→…, ODJ typé, pièces jointes, CR structuré | 📋 Proposé | [RFC](./RFC-PROJ-013-2%20—%20Point%20projet%20de%20pilotage%20(COPIL,%20COPROJ,%20revues,%20arbitrages).md) — reoriente RFC-PROJ-013-1 |
