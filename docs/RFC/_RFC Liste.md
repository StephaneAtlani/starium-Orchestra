...
| **RFC-033** | Versions budgétaires (produit) — version figée = snapshot | 🟡 Draft | [RFC](./RFC-033%20%E2%80%94%20Mise%20en%20place%20des%20versions%20budg%C3%A9taires%20(produit).md) — copie lecture seule pour une occasion ; entité `BudgetSnapshot` ; distinct des révisions RFC-019 ; UI `/budgets/[budgetId]/snapshots` à finaliser |
