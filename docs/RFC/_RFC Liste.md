...
| 31a-6 | **RFC-PROJ-INTAKE-002** | CDC Demandes de projet (circuit configurable et fidélité visuelle) | Circuit seuils/exempt, machine à états, journal, UI A1–A7, seed 8 DP | 🟢 Implémenté (P0–P5) | [RFC](./RFC-PROJ-INTAKE-002%20—%20CDC%20Demandes%20de%20projet%20(circuit%20configurable%20et%20fidélité%20visuelle).md) — migration `20260914140000_…` ; ODJ Cycles live + PLA = partiel ; P6–P9 stubs |
