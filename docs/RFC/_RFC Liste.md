...
| RFC | Nom | État | Commentaire |
| --- | --- | --- | --- |
| **RFC-ACL-001** | Abonnements et licences client | 📝 Draft | Socle subscriptions + quotas + licence sur `ClientUser` ; routes plateforme/client et garde-fous quota ; voir [RFC](./RFC-ACL-001%20%E2%80%94%20Abonnements%20et%20licences%20client.md) |
| **RFC-ACL-002** | Licences spéciales et évaluation | 📝 Draft | Modes `EXTERNAL_BILLABLE`, `NON_BILLABLE`, `PLATFORM_INTERNAL`, `EVALUATION` ; motifs/expiration/audit renforcé ; voir [RFC](./RFC-ACL-002%20%E2%80%94%20Licences%20sp%C3%A9ciales%20et%20%C3%A9valuation.md) |
| **RFC-ACL-003** | Groupes d’accès client | 📝 Draft | Référentiel groupes client-scopés (`AccessGroup`, `AccessGroupMember`) ; base pour visibilité modules et ACL ; voir [RFC](./RFC-ACL-003%20%E2%80%94%20Groupes%20d%E2%80%99acc%C3%A8s%20client.md) |
| **RFC-ACL-004** | Visibilité des modules | 📝 Draft | Masquage module par client/groupe/utilisateur avec priorité `USER > GROUP > CLIENT` ; voir [RFC](./RFC-ACL-004%20%E2%80%94%20Visibilit%C3%A9%20des%20modules.md) |
| **RFC-ACL-005** | ACL ressources génériques | 📝 Draft | Moteur ACL réutilisable (`USER`/`GROUP`, `READ`/`WRITE`/`ADMIN`) avec fallback compat “sans ACL” ; voir [RFC](./RFC-ACL-005%20%E2%80%94%20ACL%20ressources%20g%C3%A9n%C3%A9riques.md) |
| **RFC-ACL-006** | Intégration ACL dans les modules métier | 📝 Draft | Branchement progressif ACL dans modules métier (projets, budgets, contrats, etc.) ; voir [RFC](./RFC-ACL-006%20%E2%80%94%20Int%C3%A9gration%20ACL%20dans%20les%20modules%20m%C3%A9tier.md) |
...
| **RFC-ACL-009** | Expiration automatique et jobs | 📝 Draft | Jobs d’expiration (évaluation, support, abonnements hors grâce) + notifications ; voir [RFC](./RFC-ACL-009%20%E2%80%94%20Expiration%20automatique%20et%20jobs.md) |
| **RFC-ACL-010** | UX cockpit licences et droits | 📝 Draft | Cockpit lisible des statuts/quotas/droits effectifs pour admins ; voir [RFC](./RFC-ACL-010%20%E2%80%94%20UX%20cockpit%20licences%20et%20droits.md) |
| **RFC-ACL-011** | Matrice des droits effectifs | 📝 Draft | Vue diagnostic “pourquoi accès/refus” sur l’intersection licence/module/RBAC/ACL ; voir [RFC](./RFC-ACL-011%20%E2%80%94%20Matrice%20des%20droits%20effectifs.md) |
| **RFC-ACL-012** | Commercialisation et reporting licences | 📝 Draft | KPI business licences/abonnements/évaluations et exports plateforme ; voir [RFC](./RFC-ACL-012%20%E2%80%94%20Commercialisation%20et%20reporting%20licences.md) |
