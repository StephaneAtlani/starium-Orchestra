...
| 14d′  | **RFC-PROJ-013-1** | Cycle de vie réunion Point projet | Statuts `PLANNED`/`IN_REVIEW`, mode visio/présentiel + lien réunion, invitations (in-app / email / Teams) | ❌ À faire | [RFC](./RFC-PROJ-013-1%20—%20Cycle%20de%20vie%20réunion%20Point%20projet%20(planification,%20invitations,%20tenue).md) — Phase 1 sans dépendance externe |
