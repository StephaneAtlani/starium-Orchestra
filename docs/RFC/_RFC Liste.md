...
| **RFC-COMP-001-A** | Évaluation opérationnelle (V1) | 📝 Draft — **P0 backlog** | Modale évaluer + preuves + N/A + KPI `A` + pont risque — [RFC](./RFC-COMP-001-A%20%E2%80%94%20%C3%89valuation%20op%C3%A9rationnelle%20(V1).md) · items `COMP.0`–`COMP.5` |
