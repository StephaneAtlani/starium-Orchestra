...
| **RFC-FE-BUD-031** | Portefeuille budgets UI (refonte mockup) | 📝 Draft — plan | [RFC](./RFC-FE-BUD-031%20%E2%80%94%20Portefeuille%20budgets%20UI%20(refonte%20mockup).md) — `/budgets` portefeuille financier (consolidation exercice, cartes/table KPI) ; alignement fiche `/budgets/[budgetId]` ; API reporting existante, pas de Prisma MVP |
