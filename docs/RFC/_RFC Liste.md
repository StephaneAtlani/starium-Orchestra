...
| **RFC-STRAT-011** | CDC Stratégie de direction et Consolidé groupe (fidélité mock) | ✅ Implémentée | [RFC](./RFC-STRAT-011%20%E2%80%94%20CDC%20Strat%C3%A9gie%20de%20direction%20et%20Consolid%C3%A9%20groupe%20(fid%C3%A9lit%C3%A9%20mock).md) — portefeuille `.stg-card`, fiche schéma (`/strategic-direction-strategy/[id]`), consolidé groupe, `GET portfolio` / `schema-metrics` / `consolidation`, PDF print 1 page ; socle STRAT-005/006 |
