...
| **RFC-BUD-043** | Import CSV/Excel — centre de gestion (Configuration → Imports) | 📝 Draft | [RFC](./RFC-BUD-043%20%E2%80%94%20Import%20budg%C3%A9taire%20CSV%20Excel%20%E2%80%94%20centre%20de%20gestion.md) — profils (`importPurpose`), historique jobs, modèle CSV, hub `/budgets/imports` ; clarifie RFC-018 côté produit |
