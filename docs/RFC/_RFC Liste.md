...
| 14c′  | **RFC-PROJ-DOC-002** | Silo Documents + rattachements | Onglet Documents (mock), upload/download STARIUM, picker réutilisable Points/Réunions | 📝 Draft | [RFC](./RFC-PROJ-DOC-002%20—%20Silo%20Documents%20projet%2C%20upload%20et%20rattachements.md) — supersède DOC-FE-001 ; NTH.3 |
