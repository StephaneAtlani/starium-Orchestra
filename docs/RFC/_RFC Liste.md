...
| **RFC-FE-BUD-032** | Fiche budget cockpit (refonte présentation & fonctionnalités) | 📝 Draft | [RFC](./RFC-FE-BUD-032%20%E2%80%94%20Fiche%20budget%20cockpit%20(refonte%20pr%C3%A9sentation%20%26%20fonctionnalit%C3%A9s).md) — `/budgets/[budgetId]` : 3 zones, 6 onglets métier, KPI/alertes persistants, snapshots, import/export, direction, suppression scénarios fake ; Lot F dénouement engagé/facture |
