...
| **RFC-TEAM-004** | Compétences des collaborateurs | 📝 RFC rédigée | Association `Collaborator ↔ Skill` avec niveau réel, source, commentaire, date de revue, validation manager ; CRUD + bulk + vue inversée ; voir [RFC](./RFC-TEAM-004%20%E2%80%94%20Comp%C3%A9tences%20des%20collaborateurs.md) |
