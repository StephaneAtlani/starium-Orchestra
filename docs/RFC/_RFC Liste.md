...
| 14d⁷  | **RFC-PROJ-013-7** | Listes / Séries / Préparation | Écrans 01–08 + création typée 13–17 ; figer ODJ ; `summary` / séries | ✅ Implémenté | [RFC](./RFC-PROJ-013-7%20—%20Listes%20par%20état%20Séries%20et%20Préparation%20(écrans%2001-08).md) — migration `20260910103522_proj_013_7_review_lists_series` |
| 14d⁸  | **RFC-PROJ-013-8** | Remontées / Finalisation / CR | Écrans 11+19 (checklist, push Task/Risk opt-in, DocumentView) ; F3 remontées reporté | ✅ F2/F4/F5 · 📝 F3 | [RFC](./RFC-PROJ-013-8%20—%20Remontées%20Finalisation%20et%20CR%20(écrans%2010-11-19).md) |
