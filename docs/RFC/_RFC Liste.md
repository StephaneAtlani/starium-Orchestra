...
| **RFC-COMP-002** | Campagnes et dossier d’audit (V2) | 📝 Draft | Après 001-A ; campagnes / instantanés / import évaluations — [RFC](./RFC-COMP-002%20%E2%80%94%20Campagnes%20et%20dossier%20d'audit.md) |
| **RFC-COMP-003** | CDC Conformité (fidélité mock) | ✅ UX.0–3 · Draft campagnes | Fiche `/compliance/frameworks/[id]` + overview API + remédiation — [RFC](./RFC-COMP-003%20%E2%80%94%20CDC%20Conformit%C3%A9%20(fid%C3%A9lit%C3%A9%20mock).md) · COMP.V2 reste ouvert |
