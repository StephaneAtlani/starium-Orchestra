...
| **RFC-BUD-040** | Unification atterrissage, prévision et forecast | 📝 Draft — **décisions produit OK** (2026-08-28) | [RFC](./RFC-BUD-040%20%E2%80%94%20Unification%20atterrissage%2C%20pr%C3%A9vision%20et%20forecast.md) — moteur `BudgetLandingService`, KPI **Atterrissage**, onglet **Prévisionnel** conservé, fusion `/reporting` → fiche Comparaisons, pas de backfill snapshots ; simplification UX (1 écran, 1 chiffre fin d'exercice) |
