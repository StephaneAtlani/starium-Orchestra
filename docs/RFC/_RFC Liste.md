...
| **RFC-033** | Mise en place des versions budgétaires (produit) | ✅ Implémenté (MVP) | [RFC](./RFC-033%20%E2%80%94%20Mise%20en%20place%20des%20versions%20budg%C3%A9taires%20(produit).md) — UI `/budgets/[id]/versions`, cycles T1/T2/clôture (`budgets.versioning_cycle.manage`), seed permission |
| **RFC-034** | Types de version budgétaire configurables | 📝 Draft | [RFC](./RFC-034%20%E2%80%94%20Types%20de%20version%20budg%C3%A9taire%20configurables.md) — référentiel par client (`BudgetVersionType`), UI options `/budgets/workflow-settings`, FK sur `Budget`, complète RFC-019 / RFC-033 sans remplacer `versionKind` / `versionStatus` |
