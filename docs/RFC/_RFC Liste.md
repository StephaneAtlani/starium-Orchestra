...
| **RFC-032** | Historisation décisions budgétaires | 📝 Proposition | [RFC](./RFC-032%20%E2%80%94%20Historisation%20d%C3%A9cisions%20budg%C3%A9taires.md) — journal décisionnel (statuts, prévisionnel, montants) sur budget / enveloppe / lignes ; s’appuie sur `AuditLog` + endpoint enrichi et timeline UI |
