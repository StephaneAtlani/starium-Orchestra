...
- **MailHog** (capture SMTP — OTP MFA, etc.) : `http://localhost:8025` ; l’API `api-dev` est configurée avec `SMTP_HOST=mailhog` et `SMTP_PORT=1025` (voir `docker-compose.dev.yml`).
