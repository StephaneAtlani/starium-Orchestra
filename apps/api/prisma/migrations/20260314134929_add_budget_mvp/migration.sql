-- CreateEnum
CREATE TYPE "BudgetExerciseStatus" AS ENUM ('DRAFT', 'ACTIVE', 'CLOSED');

-- CreateEnum
CREATE TYPE "BudgetStatus" AS ENUM ('DRAFT', 'ACTIVE', 'LOCKED', 'CLOSED');

-- CreateEnum
CREATE TYPE "BudgetEnvelopeType" AS ENUM ('RUN', 'BUILD', 'TRANSVERSE');

-- CreateEnum
CREATE TYPE "BudgetLineExpenseType" AS ENUM ('OPEX', 'CAPEX');

-- CreateEnum
CREATE TYPE "BudgetLineStatus" AS ENUM ('DRAFT', 'ACTIVE', 'LOCKED');

-- CreateEnum
CREATE TYPE "FinancialAllocationSourceType" AS ENUM ('PROJECT', 'ACTIVITY', 'SUPPLIER', 'CONTRACT', 'LICENSE', 'ORDER', 'TEAM_ASSIGNMENT', 'APPLICATION', 'ASSET', 'MANUAL');

-- CreateEnum
CREATE TYPE "FinancialAllocationType" AS ENUM ('PLANNED', 'RESERVED', 'COMMITTED', 'CONSUMED', 'FORECAST', 'REALLOCATED', 'CANCELLED');
...
CREATE TABLE "BudgetLine" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "expenseType" "BudgetLineExpenseType" NOT NULL,
    "status" "BudgetLineStatus" NOT NULL DEFAULT 'DRAFT',
    "currency" TEXT NOT NULL,
    "initialAmount" DECIMAL(19,4) NOT NULL DEFAULT 0,
    "revisedAmount" DECIMAL(19,4) NOT NULL DEFAULT 0,
    "forecastAmount" DECIMAL(19,4) NOT NULL DEFAULT 0,
...
CREATE TABLE "FinancialAllocation" (
    ...
    "sourceType" "FinancialAllocationSourceType" NOT NULL,
    "sourceId" TEXT NOT NULL,
    "allocationType" "FinancialAllocationType" NOT NULL,
