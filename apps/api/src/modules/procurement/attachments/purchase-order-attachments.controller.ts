...
export class PurchaseOrderAttachmentsController {
  ...
  list(
    ...
    return this.attachments.listForPurchaseOrder(clientId!, purchaseOrderId);
  }
  ...
  upload(
    ...
    return this.attachments.createForPurchaseOrder(
      clientId!,
      purchaseOrderId,
      file,
      body,
  ...
  async download(
    ...
    const { stream, contentType, filename } =
      await this.attachments.getDownloadStreamForPurchaseOrder(
        clientId!,
        purchaseOrderId,
        attachmentId,
        { actorUserId, meta },
  ...
  archive(
    ...
    return this.attachments.archiveForPurchaseOrder(
      clientId!,
      purchaseOrderId,
      attachmentId,
      { actorUserId, meta },
