        ...
        findMany: jest.fn().mockResolvedValue([
          {
            ...
            description: null,
            isActive: true,
            types: [{ id: 'rt_general', code: 'UNCLASSIFIED', name: 'Non classé', isActive: true }],
          },
          {
            id: 'rd_legal',
            code: 'LEGAL',
            ...
            description: null,
            isActive: true,
            types: [{ id: 'rt_legal', code: 'CONTRACT_BREACH', name: 'Violation de contrat', isActive: true }],
          },
          {
            id: 'rd_lc',
            ...
            description: null,
            isActive: true,
            types: [{ id: 'rt_lc', code: 'OTHER_LEGAL_COMPLIANCE_RISK', name: 'Autre risque', isActive: true }],
          },
        ]),
      },
    } as any;
        ...
        findMany: jest.fn().mockResolvedValue([
          {
            ...
            description: null,
            isActive: false,
            types: [{ id: 'rt_legal', code: 'CONTRACT_BREACH', name: 'Violation de contrat', isActive: false }],
          },
        ]),
      },
    } as any;
