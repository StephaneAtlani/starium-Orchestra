 ...
 * Miroir API : apps/api/.../project-review-prepare-guards.ts
 */
...
export function canFreezePrepare(
...
export function isDecisionLikeAgendaType(itemType: string): boolean {
  return DECISION_LIKE.has(itemType);
}
