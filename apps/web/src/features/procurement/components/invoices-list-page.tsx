        ...
        >
          <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            <FilterBar
              ...
              desktopColumns={2}
            >
              <FilterBarField id="invoices-search" label="Recherche">
                {({ controlId }) => (
              ...
              <FilterBarField id="invoices-include-cancelled" label="Annulées">
                {({ controlId, labelId }) => (
        ...
        {q.isSuccess && (
          <>
            <DataTable
              ...
              data={items}
              getRowId={(row) => row.id}
              mobileCardsAriaLabel="Liste des factures"
              emptyTitle="Aucune facture"
              emptyDescription="Aucune facture ne correspond aux filtres."
            />
