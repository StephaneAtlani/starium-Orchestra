...
export function SuppliersListKpiStrip({
  ...
  return (
    <section className="space-y-2" aria-labelledby="suppliers-kpi-heading">
      <div>
        <h2 id="suppliers-kpi-heading" className="text-sm font-semibold text-foreground">
          Synthèse du panel
        </h2>
        <p className="text-xs text-muted-foreground">
          Tous les fournisseurs du client, indépendamment des filtres ci-dessous.
        </p>
      </div>
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <KpiCard
