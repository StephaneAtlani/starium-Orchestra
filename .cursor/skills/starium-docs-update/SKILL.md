...
6. **[docs/](docs/) (racine)** — guides, index et documents transverses (hors RFC ponctuelles) ; les mettre à jour et vérifier cohérence, liens et alignement avec le code.
